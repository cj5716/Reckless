...
const FT_QUANT: i64 = 181;
const L1_QUANT: i64 = 64;

#[cfg(target_feature = "avx512f")]
const FT_SHIFT: u32 = 25;
#[cfg(not(target_feature = "avx512f"))]
const FT_SHIFT: i32 = 25;

const DEQUANT_MULTIPLIER: f32 = ((1 << FT_SHIFT) as f64 / (FT_QUANT * FT_QUANT * FT_QUANT * FT_QUANT * L1_QUANT) as f64) as f32;
